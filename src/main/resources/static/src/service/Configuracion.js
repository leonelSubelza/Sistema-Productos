...
export const IMAGES_URL_PRODUCT_TYPE = "http://localhost:8080/static/images/productsType/";
...
export const ADMIN_CANT_OBJ_TO_SHOW = 5;
export const CLIENT_CANT_OBJ_TO_SHOW = 4;
